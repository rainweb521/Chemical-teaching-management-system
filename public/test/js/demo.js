  ...
  $("#jplayer_1").jPlayer({
    ready: function () {
      $(this).jPlayer("setMedia", {
        title: document.getElementById('data_title').innerHTML,
        m4v: "http://flatfull.com/themes/assets/video/big_buck_bunny_trailer.m4v",
        ogv: "http://flatfull.com/themes/assets/video/big_buck_bunny_trailer.ogv",
        webmv: document.getElementById('data_video').innerHTML,
        poster: document.getElementById('data_picture').innerHTML
      });
    },
    swfPath: "js",
